...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item" style="margin: 0 10px; line-height: 40px">
        <!-- <a style="text-decoration: none; color: black;" href="">Log Out</a> -->
        <a href="#" style="color: black">
          <div>
              <a style="color: black;" href="{{ route('admin.logout') }}"
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <div style="display: table;background: white">
      <a href="{{ asset('/') }}" class="brand-link">
        <img style="width: 100%;" src="{{asset('homestore/images/logo.png')}}"
             alt="AdminLTE Logo">
      </a>
    </div>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ asset('admin/promotion') }}" class="nav-link">
...
{{-- <script src="htpps://code.jquery.com/jquery-3.2.1.slim.min.js"></script> --}}
